...
4. [COMPAS dataset analysis](pages/compas-t1.Rmd) from Example 6.1 of [@plecko2022causal, Section 6],

5.  [Conditional independence tests on COMPAS & Census datasets](pages/ci-tests.Rmd) from Figure 4.7 of [@plecko2022causal, Section 4.5],

6. [Outcome Control Cancer Surgery Example](pages/outcome-control.qmd) from [@plecko2022causal, Section 5.3.3]. 
