...
In the above, `resp_oc` is S3-class object of type `fair_decision`. 
We can use the `autoplot()` generic to analyze various important aspects of the decision making process:
