...
The data scientist has read the Causal Fairness Analysis paper and now wants to understand how this observed disparity relates to the underlying causal mechanisms that generated it. To this end, he constructs the Standard Fairness Model (see [Plecko & Bareinboim, Definition 4](https://causalai.net/r90.pdf)) associated with this dataset:
...
```{r CFA, fig.width=12, fig.height=6}
...
direct, indirect effects, namely:
...
In particular, the dataset might show evidence of disparate treatment, which needs
